...
export default function (pi: ExtensionAPI) {
  pi.registerTool({
    ...
    parameters: Type.Object({ event: Type.String(), tripId: Type.Optional(Type.String()), revision: Type.Optional(Type.Integer()), attributes: Type.Optional(Type.Record(Type.String(), Type.Any())) }),
