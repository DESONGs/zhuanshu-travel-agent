...
export default function (pi: ExtensionAPI) {
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...
      travelers: Type.Optional(Type.Array(Type.Any())),
    }),
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({ state: Type.Any(), node: Type.Any() }),
    async execute(_id, params) {
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({ state: Type.Any(), edge: Type.Any() }),
    async execute(_id, params) {
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({ state: Type.Any(), claim: Type.Any() }),
    async execute(_id, params) {
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({ state: Type.Any(), offer: Type.Any() }),
    async execute(_id, params) {
