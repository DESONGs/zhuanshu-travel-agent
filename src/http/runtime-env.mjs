...
const ALLOWED_FILE_KEYS = new Set([
  ...
  "TRAVEL_AGENT_DESKTOP_AUTH_ENABLED",
  "TRAVEL_AGENT_DESKTOP_DEEP_LINK_SCHEME",
  "TRAVEL_AGENT_DESKTOP_API_ORIGIN",
  "GOOGLE_CLIENT_ID",
  ...
  "WEB_CONCURRENCY",
  "TRAVEL_AGENT_SOCIAL_WORKER_ENABLED",
  "TRAVEL_AGENT_SOCIAL_WORKER_AUDIT_STATUS",
  "TRAVEL_AGENT_SOCIAL_WORKER_TERMS_STATUS",
...
export async function loadTravelRuntimeEnv({
  ...
  if (!env.TRAVEL_AGENT_DESKTOP_AUTH_ENABLED) env.TRAVEL_AGENT_DESKTOP_AUTH_ENABLED = "false";
  if (!env.TRAVEL_AGENT_DESKTOP_DEEP_LINK_SCHEME) env.TRAVEL_AGENT_DESKTOP_DEEP_LINK_SCHEME = "zhuanshu-travel";
  ...
  if (!env.TRAVEL_AGENT_SOCIAL_WORKER_ENABLED) env.TRAVEL_AGENT_SOCIAL_WORKER_ENABLED = "false";
  if (!env.TRAVEL_AGENT_SOCIAL_WORKER_AUDIT_STATUS) env.TRAVEL_AGENT_SOCIAL_WORKER_AUDIT_STATUS = "not_run";
  if (!env.TRAVEL_AGENT_SOCIAL_WORKER_TERMS_STATUS) env.TRAVEL_AGENT_SOCIAL_WORKER_TERMS_STATUS = "not_reviewed";
  if (!env.TRAVEL_AGENT_SOCIAL_WORKER_SMOKE_STATUS) env.TRAVEL_AGENT_SOCIAL_WORKER_SMOKE_STATUS = "not_run";
