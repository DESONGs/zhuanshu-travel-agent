...
> 当前状态：**问题基线已记录，等待开发逐项修复与复验**
> 代码定位：分支 `codex/v2-deployment-readme-release`，基础提交 `4e09825`
...
| --- | --- | --- | --- | --- | --- | --- |
| TA-UX-001 | P0 | 航班到达节点误用出发时间，导致首日时间逆序 | OPEN | TBD |  |  |
| TA-UX-002 | P0 | 时间不可能、路线不完整时“采用此方案”仍可点击 | OPEN | TBD |  |  |
| TA-UX-003 | P0 | 多日路线缺少 Day/Date 语义，住宿回环重复且时间相同 | OPEN | TBD |  |  |
| TA-UX-004 | P1 | 交通候选没有满足“飞机/高铁”意图，无票普通列车占据首屏 | OPEN | TBD |  |  |
| TA-UX-005 | P1 | 首次规划等待约 90 秒，无部分结果、ETA、取消或后台继续 | OPEN | TBD |  |  |
| TA-UX-006 | P1 | 路线 Δ 使用空基准，且缺少交通方式切换比较 | OPEN | TBD |  |  |
| TA-UX-007 | P1 | “命中人民广场”没有转换成距离、耗时和实际可达性 | OPEN | TBD |  |  |
| TA-UX-008 | P1 | 本地/小众餐饮相关性不足，低评分商业美食城成为首选 | OPEN | TBD |  |  |
| TA-UX-009 | P1 | “让 AI 优化站序”仅预填文本，行为与按钮承诺不一致 | OPEN | TBD |  |  |
| TA-UX-010 | P1 | 桌面候选卡操作发生布局越界，主要 CTA 不可见 | OPEN | TBD |  |  |
| TA-UX-011 | P1 | 酒店详情价格文案矛盾、图片/坐标/跳转不足 | OPEN | TBD |  |  |
| TA-UX-012 | P2 | Activity 与地图暴露 `saved/proposed/开发底图` 等工程语言 | OPEN | TBD |  |  |
| TA-A11Y-001 | P2 | 移动端部分可点击控件不足 44px | OPEN | TBD |  |  |
| TA-CONTENT-001 | P2 | Provider 营销长文和错字直接进入体验卡，影响可信度与扫描 | OPEN | TBD |  |  |
...
- [ ] TA-UX-001 到达时间语义
- [ ] TA-UX-002 确认前可执行性 Gate
- [ ] TA-UX-003 Day Plan 与住宿回环
...
- [ ] TA-UX-008 长尾餐饮证据
- [ ] TA-UX-011 酒店实体/Offer/详情融合
- [ ] TA-CONTENT-001 内容摘要与去推广
